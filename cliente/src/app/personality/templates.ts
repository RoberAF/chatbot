// src/app/personality/templates.ts
// Plantillas predefinidas para la creación de personalidades

export interface PersonalityTemplate {
    id: string;
    name: string;
    description: string;
    icon: string; // Nombre del icono (se usará para renderizar el SVG adecuado)
    ...
    traits: {
      ...
      hobbies: string[];
      quirks: string;
      // Otros rasgos específicos según la categoría
      specialties?: string[];
