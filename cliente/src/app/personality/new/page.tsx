...
// Componente para los iconos de categorías
...
export default function TemplateSelectionPage() {
  ...
  // Función para seleccionar plantilla y continuar
  const handleContinue = async () => {
    ...
    // Guardamos el template en sessionStorage para usarlo en la página de personalización
    sessionStorage.setItem('selectedTemplate', JSON.stringify(template));
    
    // Redirigimos a la página de personalización con el id de la plantilla
    router.push(`/personality/customize?template=${selectedTemplate}`);
  };

  // Función para crear personalidad completamente personalizada
  const handleCustom = () => {
