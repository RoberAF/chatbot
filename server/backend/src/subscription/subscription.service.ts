...
export class SubscriptionService {
  ...
  async getStatus(userId: number) {
    ...
    try {
      ...
      this.logger.log(`getStatus: tier=${sub.tier} expiresAt=${sub.expiresAt}`);
  ...
  /**
   * Crea o recupera el customer de Stripe vinculado al usuario.
   */
  ...
  /**
   * Genera una sesión de Checkout de Stripe para suscripción.
   */
